...
btn0=Button(logs,text="0",padx="40",pady="20",command=lambda:btnClick(0))
btn1=Button(logs,text="1",padx="40",pady="20",command=lambda:btnClick(1) )
btn2=Button(logs,text="2",padx="40",pady="20",command=lambda:btnClick(2) )
btn3=Button(logs,text="3",padx="40",pady="20",command=lambda:btnClick(3) )
btn4=Button(logs,text="4",padx="40",pady="20",command=lambda:btnClick(4) )
btn5=Button(logs,text="5",padx="40",pady="20",command=lambda:btnClick(5) )
btn6=Button(logs,text="6",padx="40",pady="20",command=lambda:btnClick(6) )
btn7=Button(logs,text="7",padx="40",pady="20",command=lambda:btnClick(7) )
btn8=Button(logs,text="8",padx="40",pady="20",command=lambda:btnClick(8) )
btn9=Button(logs,text="9",padx="40",pady="20",command=lambda:btnClick(9) )
btnSask=Button(logs,text="+",padx='40',pady="20",command=lambda:btnCommand("+") )
